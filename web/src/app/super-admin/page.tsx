      ...
      <div className="flex flex-col gap-4 mb-10 relative z-10">
         ...
         <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-4">
           <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-4">
              <div className="relative h-12 w-12 md:h-14 md:w-14 rounded-2xl overflow-hidden border-2 border-slate-200 dark:border-slate-800 shadow-lg rotate-3 flex-shrink-0 bg-white">
                 <Image src="/images/PA.png" alt="Protech Logo" fill className="object-cover" />
              </div>
              <div className="space-y-1">
                 <div className="flex items-center gap-2">
                    <h1 className="text-xl sm:text-2xl md:text-3xl font-[1000] text-slate-900 dark:text-white tracking-tighter uppercase italic leading-tight">Nexus <span className="text-indigo-600 dark:text-indigo-400">Admin Panel</span></h1>
                    <div className="px-2 py-0.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[7px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest h-fit">v4.2.0</div>
                 </div>
                 <div className="flex items-center gap-2">
                    <div className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
                    <p className="text-slate-500 dark:text-slate-400 font-black text-[9px] uppercase tracking-[0.25em]">Operational Level: Super Admin</p>
                 </div>
              </div>
           </motion.div>
          ...
          {[
            ...
            return (
              <button
                ...
                className={cn(
                  "flex items-center gap-2 px-3 md:px-4 py-2.5 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap shrink-0",
                  activeTab === tab.id 
              ...
              >
                ...
                <span className="sm:hidden">{tab.id === "telemetry" ? "Activity" : tab.id === "terminal" ? "Shell" : tab.id === "backups" ? "Backups" : tab.id === "operators" ? "Users" : "Settings"}</span>
              </button>
            );
          })}
        </div>
