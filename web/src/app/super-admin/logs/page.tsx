...
export default function LogsPage() {
  ...
  return (
    <div className="space-y-6 p-4 md:p-8 animate-in fade-in duration-700">
      <div>
         <h1 className="text-2xl md:text-3xl font-[1000] tracking-tight text-slate-900">System Activity Audit</h1>
         <p className="text-slate-500 font-medium text-sm md:text-base">Monitoring platform-wide transactions and admin actions.</p>
      </div>

      <Card className="rounded-[1.5rem] md:rounded-[2rem] border-none shadow-xl bg-white overflow-x-auto">
