      ...
      <header className="sticky top-0 w-full z-[100] bg-white/85 dark:bg-slate-950/85 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 transition-all duration-300">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
          ...
          <Link className="flex items-center gap-3 shrink-0 group" href="/">
            <div className="relative h-11 w-11 overflow-hidden rounded-xl shadow-md border border-slate-200 dark:border-slate-800 bg-white group-hover:scale-105 transition-transform shrink-0">
              <Image src="/images/PA.png" alt="ProTech Assist Logo" fill sizes="44px" className="object-cover p-1" unoptimized />
            </div>
            <div className="flex flex-col">
              <span className="font-black text-lg sm:text-xl tracking-tight text-slate-900 dark:text-white leading-tight">
                ProTech Assist
              </span>
              <span className="text-[10px] font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest leading-none mt-0.5">
                Enterprise OS
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2.5 sm:gap-4">
            ...
            <Link 
              href="/login" 
              className="hidden sm:flex h-10 px-5 items-center justify-center rounded-xl border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-900 text-xs font-black uppercase tracking-wider text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all shadow-xs"
            >
              Login
            </Link>
            ...
            <Link 
              href={ctaHref} 
              className="h-10 px-5 rounded-xl bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white text-xs font-black uppercase tracking-wider shadow-md shadow-indigo-600/20 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
            >
              <span>{ctaText}</span>
            ...
            {/* Mobile Menu Toggle */}
            <button 
              className="xl:hidden p-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors"
