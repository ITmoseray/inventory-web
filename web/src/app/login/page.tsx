...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950 relative">
      ...
      <Link 
        href="/" 
        className="fixed top-4 left-4 sm:top-8 sm:left-8 z-[100] inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg text-sm font-medium text-slate-500 hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-slate-800/50 dark:hover:text-white transition-colors cursor-pointer"
      >
