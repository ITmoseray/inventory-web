        ...
        {submittedSuccess ? (
          ...
          <form onSubmit={handleSubmitAndLogout} className="p-5 sm:p-7 space-y-4 overflow-y-auto flex-1 custom-scrollbar">
            ...
            <div className="flex items-center gap-2 p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/40 text-emerald-800 dark:text-emerald-300 text-xs">
              ...
              <span>
                As an active merchant, your review will be tagged with a <strong>Verified Protech Client</strong> badge!
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
              <Button
                ...
                disabled={submitting}
                className="w-full sm:w-auto order-2 sm:order-1 text-xs font-bold text-slate-500 hover:text-slate-900 dark:hover:text-white"
              >
                Skip &amp; Log Out
              </Button>
              <Button
                type="submit"
                disabled={submitting}
                className="w-full sm:w-auto order-1 sm:order-2 h-11 px-6 rounded-xl bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-700 hover:from-indigo-700 hover:to-purple-800 text-white font-black text-xs uppercase tracking-widest gap-2 shadow-lg shadow-indigo-600/20"
              >
                {submitting ? (
                  "Submitting..."
                ) : (
