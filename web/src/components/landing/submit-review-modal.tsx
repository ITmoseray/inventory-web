      ...
      <DialogContent className="max-w-xl w-full p-0 overflow-hidden bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl max-h-[90vh] flex flex-col">
        ...
        {submittedSuccess ? (
          ...
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            <div className="shrink-0 p-3 sm:p-3.5 bg-slate-50/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-200/80 dark:border-slate-800/80 flex items-center justify-end gap-2">
              <Button
                type="button"
                variant="ghost"
                size="sm"
                onClick={onClose}
                disabled={submitting}
                className="h-8 sm:h-8.5 px-3 text-xs font-semibold text-slate-500 cursor-pointer"
              >
                Cancel
              </Button>
              <Button
